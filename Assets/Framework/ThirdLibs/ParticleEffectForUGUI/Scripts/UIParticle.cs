...
namespace Coffee.UIExtensions
{
    ...
    public class UIParticle : MaskableGraphic, ISerializationCallbackReceiver
    {
        ...
        private bool _resetScaleOnEnable;
        ...
        protected override void OnEnable()
        {
            ...
            // Reset scale on enable (v3.x -> v4.x).
            if (_resetScaleOnEnable)
            {
                _resetScaleOnEnable = false;
        ...
        void ISerializationCallbackReceiver.OnAfterDeserialize()
        {
            if (m_IgnoreCanvasScaler || m_AutoScaling)
            {
                ...
                m_AutoScaling = false;
                m_AutoScalingMode = AutoScalingMode.UIParticle;
                _resetScaleOnEnable = true;
#if UNITY_EDITOR
